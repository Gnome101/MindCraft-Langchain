...
export class Examples {
  ...
  async load(examples) {
    // Process examples to handle content-file
  ...
  async getRelevant(turns) {
    ...
    // console.log("Current conversation text:", turn_text);

    if (this.model !== null) {
      let embedding = await this.model.embed(turn_text);
      // console.log("Current embedding:", embedding);
    ...
    // console.log("Selected examples:", selected);
